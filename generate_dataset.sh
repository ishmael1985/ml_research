...
python prepare_data.py --image_folder=$1 --sample_size=$2 --rotate=$3 --scale=2 --save_images --save_dataset

# Resize original images by the same factor of 2 to ensure similarity of content
python prepare_data.py --image_folder=$1 --scale=2 --save_images --dataset_csv=dataset.csv

# Split generated images in new dataset into patches and save as an hdf5 archive
python prepare_data.py --image_folder=generated --hdf5_path=train.h5
