...
for i in "${downsize[@]}"
do
	python prepare_data.py --image_folder=$1 --scale $i --save_grayscale --dataset_csv=dataset.csv
done
...
for i in "${rotate[@]}"
do
	python prepare_data.py --image_folder=generated --rotate $i --save_grayscale --dataset_csv=dataset.csv
done

# Augment with flipped images
python prepare_data.py --image_folder=generated --sample_size=-1 --save_dataset

python prepare_data.py --image_folder=generated --flip_horizontal --save_grayscale --dataset_csv=dataset.csv
python prepare_data.py --image_folder=generated --flip_vertical --save_grayscale --dataset_csv=dataset.csv
